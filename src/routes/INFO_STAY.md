...
### booked
- Бронювання створено
- Кімната залишається у статусі "free"
...
- Кімната переходить у статус "cleaning"
- Фінальний статус
...
### Check-in
1. Перевірка, що проживання у статусі "booked" (або створено як walk-in)
2. Переконуємось, що кімната доступна (статус "free")
3. Оновлення статусу проживання на "occupied"
4. Переведення кімнати у статус "occupied"

### Check-out
1. Перевірка статусу "occupied"
2. Оновлення статусу на "completed"
3. Переведення кімнати у статус "cleaning"

### Скасування
1. Перевірка статусу "booked"
2. Оновлення статусу на "cancelled"
3. Перерахунок статусу кімнати (залишається "free", якщо немає інших активних проживань)
